  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        ...
        children: <Widget>[
          Container(
            margin: EdgeInsets.only(top: Utils.getPXSize(context, 200)),
            child: widget.resultState
                ? Image.asset('images/succeed.png')
                : Image.asset('images/fail02.png'),
          ),
          Container(
            margin: EdgeInsets.only(top: Utils.getPXSize(context, 55)),
          ...
          Container(
              margin: EdgeInsets.only(top: Utils.getPXSize(context, 56)),
              child: widget.resultState
