...
class TypesDao {
  ...
  static  groupDetail(String groupId) async {
    ...
    var res = await HttpManager.netFetch(HttpManager.API_GROUP_DETAIL, params, null, null);
    if (res != null && res.result && res.data.length > 0) {
      var data = res.data;
  ...
  static goodsSearch(String key) async {
    ...
    var res = await HttpManager.netFetch(HttpManager.API_GOODS_SEARCH, params, null, null);
